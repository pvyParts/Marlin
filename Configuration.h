...
#define STRING_CONFIG_H_AUTHOR "(pvyParts, KosselXL)" // Who made the changes.
...
#define CUSTOM_MENDEL_NAME "pvyParts, KosselXL"
...
#define DEFAULT_DELTA_DIAGONAL_ROD 335.0 // mm
...
#define Z_PROBE_OFFSET {-13, -13, -7.5, 0}  // X, Y, Z, E distance between hotend nozzle and deployed bed leveling probe.
...
#define Z_PROBE_RETRACT_START_LOCATION {-50, 128, 40, 0}  // X, Y, Z, E start location for z-probe retract sequence
#define Z_PROBE_RETRACT_END_LOCATION {-50, 128, 12, 0}     // X, Y, Z, E end location for z-probe retract sequence 
...
#define MANUAL_Z_HOME_POS 288.5  // For delta: Distance between nozzle and print surface after homing.
